  ...
  return (
    <div className="flex flex-col items-center text-center">
      <motion.div
        ...
        className="flex h-16 w-16 items-center justify-center rounded-full bg-burgundy-500 text-cream-50"
      >
      ...
      <div className="mt-7 w-full rounded-2xl border border-gold-400/30 bg-cream-100 p-6">
        ...
        <p className="mt-1 font-display text-3xl text-burgundy-600">{code}</p>
      ...
      <Link href="/" className="mt-5 text-sm text-ink-700/50 hover:text-burgundy-600">
        Volver al inicio
      </Link>
    </div>
  );
