  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-burgundy-500/10 text-burgundy-600">
        ...
        {error && (
          <p className="mb-3 rounded-xl bg-burgundy-500/10 px-4 py-2.5 text-sm text-burgundy-600">
            {error}
          </p>
        )}
