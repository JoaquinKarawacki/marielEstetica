    ...
    <section id="servicios" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <SectionEyebrowHeading
          ...
          description="Tecnología de última generación, resultados progresivos y duraderos, en un espacio pensado para que te sientas cómoda."
        />
            ...
            <button
              ...
              className={cn(
                ...
                filter === f
                  ...
                  : "bg-cream-50 text-ink-700/60 ring-1 ring-ink-700/[0.07] hover:text-burgundy-600"
              )}
            >
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4 flex items-center justify-between border-t border-ink-700/[0.06] pt-4">
                    <div>
                      <p className="font-display text-lg text-burgundy-600">
                        {service.priceLabel || formatPrice(service.price)}
                      </p>
                    </div>
                    <Link
                      href={`/reservar?servicio=${service.slug}`}
                      className="group/link flex items-center gap-1.5 text-[13px] font-medium text-burgundy-600"
                    >
                      Reservar
