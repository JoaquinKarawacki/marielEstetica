  ...
  return (
    <div className="bg-noise flex min-h-screen items-center justify-center bg-cream-100 px-4">
      ...
      >
        ...
        <h1 className="mt-5 font-display text-2xl text-ink-900">Panel de Mariel</h1>
        ...
        {error && (
          <p className="mt-3 rounded-xl bg-burgundy-500/10 px-4 py-2.5 text-sm text-burgundy-600">
            {error}
          </p>
        )}
